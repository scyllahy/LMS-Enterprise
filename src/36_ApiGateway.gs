const API_ROUTES = {
  ...
  'class.list': { h:c => PortalService.listClasses(c) }, 'class.create': { h:(c,p) => PortalService.createClass(c,p) }, 'class.update': { h:(c,p) => PortalService.updateClass(c,p) }, 'class.delete': { h:(c,p) => PortalService.deleteClass(c,p.classId) },
